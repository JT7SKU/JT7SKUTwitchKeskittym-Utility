...
namespace Twitch_Api.Functions
{
    public static class GetTips
    {
            ...
            [OrchestrationTrigger] TaskOrchestrationContext context)
        {
            ...
            outputs.Add(await context.CallActivityAsync<string>("GetTips_Hello", "SharkMark"));
            outputs.Add(await context.CallActivityAsync<string>("GetTips_Hello", "SharkTony"));
            outputs.Add(await context.CallActivityAsync<string>("GetTips_Hello", "SharkNiklas"));
